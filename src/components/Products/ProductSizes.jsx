...
function ProductSizes({ generalStock, onSendSizesStock, configAlert, isSizesSaved }) {
        ...
        if (deleteSize) {
            axios.delete(`${URL_BASE}products/sizes/${id}/delete`, {
                ...
                .then(response => {
                    ...
                    configAlert('Talla borrada Exitosamente', 'success', true)
        ...
        if (data.length > 0) {
            ...
            do {
                ...
                try {
                    ...
                    console.log(response)
                    configAlert('Tallas Actualizadas correctamente', 'success', true)
                } catch (error) {
                    console.log(error)
                    errorOcurred = true
                    //console.log('Error Ocurred: ', errorOcurred)
                    configAlert('Algo Salió mal: ' + i + error.message, 'danger', true)
...
const handleAddSizeSubmit = () => {
    ...
    axios.post(`${URL_BASE}products/${productId}/sizes/create`, sizeData, {
        ...
        .then(response => {
            ...
            configAlert('Talla creada Exitosamente', 'success', true)
